      ...
      <div className="wrapper">
        <div className="top_navbar">
          ...
          <div className="top_menu">
            <div className="logo">TOKO SEBELAH</div>
            <ul>
              <li>
                <Link to="/">
  ...
  return (
    <div className="wrapper">
      <div className="main_container">
        <div className="item">
          <b style={{ fontSize: 25 }}>Selamat Datang Di Toko Sebelah</b>
          <br />
          <br />
          &emsp;Toko Sebelah menjual Kulkas spek dewa!!!!
          <br />
          <br />
          <b>
            Kulkas kita dingin brrr!!!!!!
          </b>
          <br />
          <br />
          <b>
